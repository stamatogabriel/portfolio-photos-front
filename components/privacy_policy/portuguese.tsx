...
const PolicyPortuguese: React.FC = () => {
  return (
    <div>
      <h1>Política de Privacidade</h1>

      <p>
        A sua privacidade é importante para nós. É política do site Schwarcz Photography respeitar a
        sua privacidade em relação a qualquer informação sua que possamos coletar no site
        <Link href="/">
          <a>Schwarcz Photography</a>
        </Link>
      ...
      <p>
        ...
        dados do usuário e informações pessoais, entre em contato conosco através
        <Link href="/contact">
          <a target="_blank">do nosso formulário</a>
        </Link>
        .
      </p>
      ...
      <p>
        ...
        sejam armazenados, no entanto, isso pode fazer o downgrade ou &quotquebrar&quot certos
      ...
      <ul>
        ...
        <li>
          ...
          contato ou nos formulários de comentários, os cookies podem ser configurados para lembrar
        ...
        <li>
          ...
          chamadas sempre que você interagir com uma página que for afetada por suas preferências.
          <br />
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Periodicamente, testamos novos recursos e fazemos alterações sutis na maneira como o site
        ...
        <li>
          ...
          previsões de negócios com precisão que nos permitem analisar nossos custos de publicidade
      ...
      <p>
        ...
        Schwarcz Photography oferece e com caráter enunciativo, mas não limitativo:
      </p>
      ...
      <ul>
        ...
        <li>
          B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, casas de apostas,
        ...
        <li>
          ...
          Schwarcz Photography, de seus fornecedores ou terceiros, para introduzir ou disseminar
          vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes
      ...
      <p>
        O titular de dados pessoais possui o direito de solicitar do site Schwarcz Photography, a
        qualquer momento, mediante requisição formal, informações referentes aos seus dados.
      </p>

      <p>
        O site Schwarcz Photography terá 14 dias úteis para responder às solicitações dos titulares
        de dados pessoais. Os pedidos serão analisados conforme previsto em legislação vigente e,
        por questões legais, algumas solicitações podem não ser atendidas.
      </p>
...
export default PolicyPortuguese
